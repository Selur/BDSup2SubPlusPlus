...
void ColorDialog::setParameters(
  QStringList names, QVector<QColor> currentColor, QVector<QColor> defaultColor)
#else
void ColorDialog::setParameters(
  QStringList names, QList<QColor> currentColor, QList<QColor> defaultColor)
#endif
{
    QPixmap* pixmap;
    colorNames = names;
