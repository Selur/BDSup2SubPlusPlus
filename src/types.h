...
#endif
  0x00, 0xf0, 0xcc, 0x99, 0x33, 0x11, 0xfa, 0xbb, 0x33, 0x11, 0xfa, 0xbb, 0xfa, 0xbb, 0x33, 0x11};
#if (QT_VERSION < QT_VERSION_CHECK(6, 0, 0))
const QVector<uchar> defaultPalG = {
#else
const QList<uchar> defaultPalG = {
#endif
  0x00, 0xf0, 0xcc, 0x99, 0x33, 0x11, 0x33, 0x11, 0xfa, 0xbb, 0xfa, 0xbb, 0x33, 0x11, 0xfa, 0xbb};
#if (QT_VERSION < QT_VERSION_CHECK(6, 0, 0))
const QVector<uchar> defaultPalB = {
#else
const QList<uchar> defaultPalB = {
#endif
  0xfa, 0xbb, 0x33, 0x11, 0x33, 0x11, 0x33, 0x11, 0xfa, 0xbb, 0xfa, 0xbb};
